  ...
  return (
    <>
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-4">
                ...
                <input
                  ...
                  className="w-24 px-3 py-2 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-primary-500"
                />
                <span className="text-sm text-gray-600">password(s)</span>
              </div>
              {count > 1 && (
                ...
                <div className="space-y-3">
                  ...
                  <div className="bg-gray-50 rounded-xl p-4 border border-gray-200 space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2 border-t border-gray-200">
                      <div>
                        ...
                        <div className="text-lg font-bold text-gray-900">
                          {entropy.toFixed(1)} <span className="text-sm font-normal text-gray-600">bits</span>
                        </div>
                      ...
                      <div>
                        <div className="text-xs text-gray-600 mb-1">Crack Time (offline)</div>
                        <div className="text-lg font-bold text-gray-900">
                          {crackTime || 'N/A'}
                        </div>
                        <div className="text-xs text-gray-500 mt-1">
                    ...
                    <div className="pt-2 border-t border-gray-200">
                      <div className="text-xs text-gray-600 mb-2">Character Distribution</div>
                      <div className="grid grid-cols-4 gap-3">
                        <div className="text-center">
                          <div className="text-lg font-bold text-blue-600">{passwordStats.uppercase}</div>
                          <div className="text-xs text-gray-600">A-Z</div>
                        </div>
                        <div className="text-center">
                        ...
                        <div className="text-center">
                          ...
                          <div className="text-xs text-gray-600">0-9</div>
                        </div>
                        <div className="text-center">
                          <div className="text-lg font-bold text-orange-600">{passwordStats.symbols}</div>
                          <div className="text-xs text-gray-600">Symbols</div>
                        </div>
                      </div>
                    </div>
                  </div>
      ...
      <div className="max-w-4xl mx-auto mt-16 space-y-8">
        ...
        {/* How to Use */}
        <section className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-6 lg:p-8 border border-gray-100">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">How to Use Our Password Generator</h2>
          <div className="prose prose-gray max-w-none">
            <p className="text-gray-700 leading-relaxed mb-4">
        ...
        <section className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-6 lg:p-8 border border-gray-100">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-2">🔒 Use Unique Passwords</h3>
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-2">📏 Longer is Stronger</h3>
              <p className="text-gray-700 text-sm">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-2">🔄 Change Regularly</h3>
              <p className="text-gray-700 text-sm">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-2">🔐 Use a Password Manager</h3>
              <p className="text-gray-700 text-sm">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-2">🚫 Avoid Personal Information</h3>
              <p className="text-gray-700 text-sm">
        ...
        {/* Features */}
        <section className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-6 lg:p-8 border border-gray-100">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Key Features of Our Password Generator</h2>
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="flex items-start gap-3">
              <span className="text-2xl">📊</span>
              <div>
                <h3 className="font-semibold text-gray-900 mb-1">Strength Meter</h3>
                <p className="text-gray-700 text-sm">
        ...
        {/* Password Types */}
        <section className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-6 lg:p-8 border border-gray-100">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Understanding Password Types</h2>
          <div className="space-y-4">
            <div>
              <h3 className="font-semibold text-gray-900 mb-2">Strong Passwords (20 characters)</h3>
            ...
            <div>
              <h3 className="font-semibold text-gray-900 mb-2">PIN Codes (6 digits)</h3>
              <p className="text-gray-700 text-sm mb-2">
            ...
            <div>
              <h3 className="font-semibold text-gray-900 mb-2">Memorable Passwords (12 characters)</h3>
              <p className="text-gray-700 text-sm mb-2">
            ...
            <div>
              <h3 className="font-semibold text-gray-900 mb-2">Maximum Security (32 characters)</h3>
              <p className="text-gray-700 text-sm mb-2">
        ...
        <section className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-6 lg:p-8 border border-gray-100">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Understanding Password Security & Attacks</h2>
          <div className="space-y-6">
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-3">How Passwords Are Cracked</h3>
              <div className="space-y-3">
                <div>
                  <h4 className="font-semibold text-gray-900 mb-1">Brute Force Attacks</h4>
                  <p className="text-gray-700 text-sm">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 mb-1">Social Engineering</h4>
                  <p className="text-gray-700 text-sm">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-3">Password Strength Factors</h3>
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-3">Understanding Entropy</h3>
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-3">Crack Time Estimation</h3>
              <p className="text-gray-700 text-sm mb-3">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-3">Best Practices to Avoid Being Hacked</h3>
              <ul className="list-disc list-inside space-y-2 text-gray-700 text-sm">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-3">Common Password Mistakes</h3>
              <ul className="list-disc list-inside space-y-2 text-gray-700 text-sm">
        ...
        <section className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-6 lg:p-8 border border-gray-100">
          ...
          <div className="space-y-6">
            <div>
              <h3 className="font-semibold text-gray-900 mb-2">How secure are the generated passwords?</h3>
              <p className="text-gray-700 text-sm">
            ...
            <div>
              <h3 className="font-semibold text-gray-900 mb-2">Are my passwords stored or transmitted?</h3>
              <p className="text-gray-700 text-sm">
            ...
            <div>
              <h3 className="font-semibold text-gray-900 mb-2">What makes a password strong?</h3>
              <p className="text-gray-700 text-sm">
            ...
            <div>
              <h3 className="font-semibold text-gray-900 mb-2">Should I exclude similar characters?</h3>
              <p className="text-gray-700 text-sm">
            ...
            <div>
              <h3 className="font-semibold text-gray-900 mb-2">How many passwords should I generate at once?</h3>
              <p className="text-gray-700 text-sm">
            ...
            <div>
              <h3 className="font-semibold text-gray-900 mb-2">What is the estimated crack time based on?</h3>
              <p className="text-gray-700 text-sm">
            ...
            <div>
              <h3 className="font-semibold text-gray-900 mb-2">Can I use these passwords for any service?</h3>
              <p className="text-gray-700 text-sm">
