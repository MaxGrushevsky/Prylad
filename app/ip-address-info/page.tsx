...
export default function IPAddressInfoPage() {
  ...
  const lookupIP = useCallback(async (ip: string) => {
    ...
    try {
      ...
      // If ipapi.co fails, try ip-api.com as fallback (using HTTPS via proxy or direct)
      try {
        // Try ip-api.com with HTTPS (may require CORS proxy or server-side call)
        // For now, we'll try direct HTTPS call
        ...
        // Success - set info from ip-api.com
        setInfo({
          ip: data.query || ip,
          city: data.city,
        ...
        // If HTTPS fails, try ipwhois.app as third fallback
        try {
          ...
          // Success - set info from ipwhois.app
          setInfo({
            ip: data.ip || ip,
            city: data.city,
            region: data.region,
          ...
          // All APIs failed
          const errorMessage = 'Failed to fetch IP information. The APIs may be rate-limited or the IP address may be invalid. Please try again in a few moments.'
    ...
    >
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-red-700 dark:text-red-300 mt-2">
                      Tip: Try again in a few moments. Free APIs have rate limits.
                    </p>
                  </div>
                </div>
              </div>
      ...
      <div className="max-w-4xl mx-auto space-y-8 mt-10">
        <section className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl shadow-xl p-6 lg:p-8 border border-gray-100 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 dark:text-white mb-4">How to Lookup an IP Address</h2>
        ...
        <section className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl shadow-xl p-6 lg:p-8 border border-gray-100 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 dark:text-white mb-4">What Information Can You See?</h2>
          <div className="grid md:grid-cols-2 gap-4 text-sm text-gray-700 dark:text-gray-300">
            <div>
              <h3 className="font-semibold text-gray-900 dark:text-gray-100 dark:text-white mb-2">Location Data</h3>
            ...
            <div>
              <h3 className="font-semibold text-gray-900 dark:text-gray-100 dark:text-white mb-2">Network Details</h3>
              <ul className="list-disc list-inside space-y-1">
