    ...
    >
      ...
      <div className="max-w-4xl mx-auto mt-16 space-y-8">
        ...
        <section className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-6 lg:p-8 border border-gray-100">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">What is a QR Code?</h2>
        ...
        {/* Use Cases */}
        <section className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-6 lg:p-8 border border-gray-100">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Common QR Code Use Cases</h2>
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-2">📱 Business Cards</h3>
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-2">🌐 Website Promotion</h3>
              <p className="text-gray-700 text-sm">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-2">📶 WiFi Sharing</h3>
              <p className="text-gray-700 text-sm">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-2">✉️ Email Marketing</h3>
              <p className="text-gray-700 text-sm">
        ...
        {/* Features */}
        <section className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-6 lg:p-8 border border-gray-100">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Key Features of Our QR Code Generator</h2>
          <div className="grid md:grid-cols-2 gap-6">
            <div className="flex items-start gap-3">
              <span className="text-2xl">🎨</span>
              <div>
                <h3 className="font-semibold text-gray-900 mb-1">Custom Colors</h3>
                <p className="text-gray-700 text-sm">
            ...
            <div className="flex items-start gap-3">
              <span className="text-2xl">📏</span>
              <div>
                <h3 className="font-semibold text-gray-900 mb-1">Adjustable Size</h3>
                <p className="text-gray-700 text-sm">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-semibold text-gray-900 mb-1">Error Correction</h3>
                <p className="text-gray-700 text-sm">
        ...
        {/* Tips */}
        <section className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-6 lg:p-8 border border-gray-100">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Best Practices for QR Codes</h2>
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              <span className="text-primary-600 font-bold">1.</span>
              <div>
                <h3 className="font-semibold text-gray-900 mb-1">Choose the Right Error Correction Level</h3>
                <p className="text-gray-700 text-sm">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-semibold text-gray-900 mb-1">Ensure Proper Contrast</h3>
                <p className="text-gray-700 text-sm">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-semibold text-gray-900 mb-1">Test Before Distribution</h3>
                <p className="text-gray-700 text-sm">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-semibold text-gray-900 mb-1">Provide Context</h3>
                <p className="text-gray-700 text-sm">
        ...
        <section className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-6 lg:p-8 border border-gray-100">
          ...
          <div className="space-y-6">
            <div>
              <h3 className="font-semibold text-gray-900 mb-2">Are the QR codes generated here free to use?</h3>
              <p className="text-gray-700 text-sm">
            ...
            <div>
              <h3 className="font-semibold text-gray-900 mb-2">What file format are the QR codes saved in?</h3>
              <p className="text-gray-700 text-sm">
