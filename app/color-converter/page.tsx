    ...
    >
      <div className="max-w-6xl mx-auto">
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-6 lg:p-8 border border-gray-100 mb-6">
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="flex justify-center">
                <input
                  ...
                  className="w-32 h-32 rounded-xl cursor-pointer border-4 border-gray-200 hover:border-primary-400 transition-all shadow-lg"
                />
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    value={hex}
                    onChange={(e) => updateFromHex(e.target.value)}
                    className="flex-1 px-4 py-3 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-primary-500 font-mono text-lg"
                    placeholder="#000000"
                  />
                  <button
              ...
              <div>
                ...
                <div className="grid grid-cols-3 gap-2 mt-2">
                  <div>
                    <label className="text-xs text-gray-600 mb-1 block">R</label>
                    <input
                      type="number"
                      min="0"
                      max="255"
                  ...
                  <div>
                    <label className="text-xs text-gray-600 mb-1 block">G</label>
                    <input
                      type="number"
                      min="0"
                      max="255"
                  ...
                  <div>
                    <label className="text-xs text-gray-600 mb-1 block">B</label>
                    <input
                      type="number"
                      min="0"
                      max="255"
              ...
              <div>
                ...
                <div className="grid grid-cols-3 gap-2 mt-2">
                  ...
                  <div>
                    <label className="text-xs text-gray-600 mb-1 block">S</label>
                    <input
                      type="number"
                      min="0"
                      max="100"
              ...
              {/* HSV */}
              <div>
                <label className="block text-sm font-semibold text-gray-700 mb-2">HSV</label>
                <div className="flex gap-2">
                  <input
                    type="text"
                    value={`hsv(${hsv.h}, ${hsv.s}%, ${hsv.v}%)`}
                    readOnly
                    className="flex-1 px-4 py-3 border-2 border-gray-200 rounded-lg bg-gray-50 font-mono text-lg"
                  />
                  <button
              ...
              {/* CMYK */}
              <div>
                <label className="block text-sm font-semibold text-gray-700 mb-2">CMYK</label>
                <div className="flex gap-2">
                  <input
                    type="text"
            ...
            <div className="grid md:grid-cols-2 gap-6 pt-4 border-t border-gray-200">
              {/* Preview */}
              <div>
                <label className="block text-sm font-semibold text-gray-700 mb-2">Color Preview</label>
                <div className="space-y-3">
                  <div
                    className="w-full h-32 rounded-xl border-2 border-gray-200 shadow-lg relative group"
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    ...
                    <div
                      className="h-16 rounded-lg border-2 border-gray-200 flex items-center justify-center bg-white"
                      style={{ color: hex }}
                    >
              ...
              {/* Color Information */}
              <div>
                <label className="block text-sm font-semibold text-gray-700 mb-2">Color Information</label>
                <div className="bg-gray-50 rounded-xl p-4 space-y-3">
                  ...
                  <div className="flex justify-between">
                    <span className="text-sm text-gray-600">Contrast (White):</span>
                    <span className={`font-semibold ${
                      contrastWithWhite >= 4.5 ? 'text-green-600' :
                      contrastWithWhite >= 3 ? 'text-yellow-600' : 'text-red-600'
                    }`}>
                      {contrastWithWhite.toFixed(2)}:1
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-sm text-gray-600">Contrast (Black):</span>
                    <span className={`font-semibold ${
                      contrastWithBlack >= 4.5 ? 'text-green-600' :
                      contrastWithBlack >= 3 ? 'text-yellow-600' : 'text-red-600'
                    }`}>
                      {contrastWithBlack.toFixed(2)}:1
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-sm text-gray-600">Best Text Color:</span>
        ...
        <div className="max-w-4xl mx-auto mt-16 space-y-8">
          ...
          {/* Color Formats */}
          <section className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-6 lg:p-8 border border-gray-100">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Color Formats Explained</h2>
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <p className="text-xs text-gray-600"><strong>Used in:</strong> Web development, CSS, HTML</p>
              </div>
              <div>
                ...
                <p className="text-xs text-gray-600"><strong>Used in:</strong> Web design, digital graphics, CSS</p>
              </div>
              <div>
                ...
                <p className="text-xs text-gray-600"><strong>Used in:</strong> CSS, design tools, color manipulation</p>
              </div>
              <div>
          ...
          <section className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-6 lg:p-8 border border-gray-100">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-900 mb-2">🎨 Design Workflow</h3>
                <p className="text-gray-700 text-sm">
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-900 mb-2">🖨️ Print Design</h3>
                <p className="text-gray-700 text-sm">
          ...
          <section className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-6 lg:p-8 border border-gray-100">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="flex items-start gap-3">
                <span className="text-2xl">🎨</span>
                <div>
                  <h3 className="font-semibold text-gray-900 mb-1">Visual Color Picker</h3>
                  <p className="text-gray-700 text-sm">
              ...
              <div className="flex items-start gap-3">
                <span className="text-2xl">📊</span>
                <div>
                  <h3 className="font-semibold text-gray-900 mb-1">Color Information</h3>
                  <p className="text-gray-700 text-sm">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 mb-1">Flexible Input</h3>
                  <p className="text-gray-700 text-sm">
          ...
          <section className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-6 lg:p-8 border border-gray-100">
            ...
            <div className="space-y-6">
              ...
              <div>
                <h3 className="font-semibold text-gray-900 mb-2">What is contrast ratio and why does it matter?</h3>
                <p className="text-gray-700 text-sm">
              ...
              <div>
                <h3 className="font-semibold text-gray-900 mb-2">Can I edit HSL values directly?</h3>
                <p className="text-gray-700 text-sm">
              ...
              <div>
                <h3 className="font-semibold text-gray-900 mb-2">Do you store the converted colors?</h3>
                <p className="text-gray-700 text-sm">
