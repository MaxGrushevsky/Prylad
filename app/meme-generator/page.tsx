...
export default function MemeGeneratorPage() {
  ...
  // SEO data
  const toolPath = '/meme-generator'
  const toolName = 'Meme Generator'
  ...
  const faqs = [
    {
      ...
      answer: "Upload your own image or select a popular meme template, add text (top and/or bottom text), customize font, size, color, and stroke, then download your meme. The meme is generated automatically as you type."
    },
    {
      question: "Can I use my own images?",
      answer: "Yes! Upload any image file (JPEG, PNG, WebP) to create a custom meme. Drag and drop or click to select. Your image is processed entirely in your browser."
    },
    {
      question: "What meme templates are available?",
      answer: "Popular templates include: Drake Pointing, Distracted Boyfriend, Change My Mind, Expanding Brain, Woman Yelling at Cat, and This Is Fine. Click on any template to use it instantly."
    },
    {
      question: "Can I customize the text?",
      answer: "Yes! Add top and/or bottom text, choose font family (Impact, Arial, Comic Sans MS, etc.), set font size, choose text color, add stroke (outline) with custom color and width, and align text (left, center, right)."
    },
    {
      question: "How do I download my meme?",
      answer: "Click the 'Download' button to save your meme as a PNG image. The meme is ready to share on social media, forums, or anywhere else."
    },
    {
      question: "Is the meme generator free?",
      answer: "Yes, completely free! No registration, no limits, no watermarks, no hidden fees. All meme generation happens in your browser - we never see or store your images."
    }
  ]
  ...
  const howToSteps = [
    {
      name: "Choose Image or Template",
      text: "Upload your own image by dragging and dropping or clicking to select, or choose from popular meme templates like Drake Pointing, Distracted Boyfriend, or Change My Mind."
    },
    {
      name: "Add Text",
      text: "Enter top text and/or bottom text for your meme. The text appears on the image in real-time as you type."
    },
    {
      name: "Customize Text Style",
      text: "Choose font family (Impact, Arial, Comic Sans MS, etc.), set font size, select text color, add stroke (outline) with custom color and width, and align text (left, center, right)."
    },
    {
      name: "Preview Meme",
      text: "See your meme update in real-time as you make changes. The preview shows exactly how your final meme will look."
    },
    {
      name: "Download Meme",
      text: "Click 'Download' to save your meme as a PNG image. Share it on social media, forums, or anywhere else!"
    }
  ]
  ...
  const structuredData = [
    ...
    generateHowToSchema(
      "How to Create Memes",
      "Learn how to create memes online using our free meme generator tool with templates and custom images.",
      howToSteps,
      "PT2M"
    ),
    generateSoftwareApplicationSchema(
      "Meme Generator",
      "Free online meme generator. Create memes with your own images or popular templates. Add text, customize fonts and colors, and download instantly. Perfect for creating funny memes.",
      "https://prylad.pro/meme-generator",
      "WebApplication"
    )
  ]
      ...
      <div className="max-w-6xl mx-auto space-y-6">
        <div className="grid lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl shadow-xl p-6 lg:p-8 border border-gray-100 dark:border-gray-700 space-y-6">
            ...
            {/* Popular Templates */}
            <div>
              <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3">Popular Templates:</label>
              <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
                {memeTemplates.map((template) => (
                  <button
                    key={template.name}
                    onClick={() => loadTemplate(template)}
                    className="px-3 py-2 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-600 text-xs font-medium transition-colors"
                  >
                    {template.name}
                  </button>
                ))}
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Stroke Color</label>
                <label className="relative block cursor-pointer group">
                  <input
                    type="color"
                    value={strokeColor}
          ...
          <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl shadow-xl p-6 lg:p-8 border border-gray-100 dark:border-gray-700 space-y-6">
            ...
            {(image || imageUrl) ? (
              <div className="space-y-4">
                <div className="border-2 border-gray-200 dark:border-gray-700 rounded-lg p-4 bg-gray-50 dark:bg-gray-800 overflow-auto max-h-[600px]">
                  <canvas
                    ref={canvasRef}
              ...
              <div className="border-2 border-dashed border-gray-200 dark:border-gray-700 rounded-xl p-8 bg-gray-50 dark:bg-gray-800 text-center text-gray-400 dark:text-gray-500">
                <p className="font-semibold text-gray-700 dark:text-gray-300 mb-2">Meme will appear here</p>
        ...
        <div className="max-w-4xl mx-auto mt-16 space-y-8">
          <section className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl shadow-xl p-6 lg:p-8 border border-gray-100 dark:border-gray-700">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4">What is a Meme Generator?</h2>
          ...
          <section className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl shadow-xl p-6 lg:p-8 border border-gray-100 dark:border-gray-700">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4">How to Use Our Meme Generator</h2>
            <div className="prose prose-gray max-w-none">
          ...
          <section className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl shadow-xl p-6 lg:p-8 border border-gray-100 dark:border-gray-700">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4">Popular Meme Templates</h2>
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">🎯 Drake Pointing</h3>
                <p className="text-gray-700 dark:text-gray-300 text-sm">
                  The classic &quot;No&quot; vs &quot;Yes&quot; meme. Perfect for comparing two options or showing preference.
                </p>
              </div>
              <div>
                <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">👀 Distracted Boyfriend</h3>
                <p className="text-gray-700 dark:text-gray-300 text-sm">
                  The distracted boyfriend meme. Great for showing temptation or being torn between choices.
                </p>
              </div>
              <div>
                <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">💭 Change My Mind</h3>
                <p className="text-gray-700 dark:text-gray-300 text-sm">
                  The &quot;Change my mind&quot; meme. Perfect for expressing strong opinions or controversial takes.
                </p>
              </div>
              <div>
                <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">🧠 Expanding Brain</h3>
                <p className="text-gray-700 dark:text-gray-300 text-sm">
          ...
          <section className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl shadow-xl p-6 lg:p-8 border border-gray-100 dark:border-gray-700">
            ...
            <div className="space-y-6">
              ...
              <div>
                <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">Can I use my own images?</h3>
                <p className="text-gray-700 dark:text-gray-300 text-sm">
              ...
              <div>
                <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">What&apos;s the maximum image size?</h3>
                <p className="text-gray-700 dark:text-gray-300 text-sm">
              ...
              <div>
                <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">Can I customize the text appearance?</h3>
                <p className="text-gray-700 dark:text-gray-300 text-sm">
