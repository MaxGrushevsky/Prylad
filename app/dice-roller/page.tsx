    ...
    >
      <div className="max-w-4xl mx-auto space-y-6">
            ...
            {coinHistory.length > 0 && (
              <div className="flex flex-wrap gap-2 justify-center max-w-md">
                ...
                {coinHistory.length > 10 && (
                  <span className="text-sm text-gray-500">+{coinHistory.length - 10} more</span>
                )}
              </div>
            )}
          </div>
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-6 lg:p-8 border border-gray-100">
          ...
          <div className="space-y-4 mb-6">
            {dice.map((d, index) => (
              <div key={index} className="flex flex-wrap gap-3 items-center p-4 bg-gray-50 rounded-lg border border-gray-200">
                    ...
                    <div className="flex justify-between items-center">
                      <div>
                        <span className="font-medium">
                          ...
                          {diceConfig.bonus !== 0 && (
                            <span className={diceConfig.bonus > 0 ? 'text-green-600' : 'text-red-600'}>
                        ...
                        <div className="text-sm text-gray-600 mt-1">
                          ...
                          {result.bonus !== 0 && (
                            <span className={result.bonus > 0 ? 'text-green-600' : 'text-red-600'}>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-6 lg:p-8 border border-gray-100">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              <div className="p-3 bg-blue-50 rounded-lg">
                <div className="text-xs text-gray-600">Total Rolls</div>
              ...
              {stats.natural20s > 0 && (
                <div className="p-3 bg-yellow-50 rounded-lg">
                  <div className="text-xs text-gray-600">Natural 20s</div>
                  <div className="text-2xl font-bold text-yellow-600">{stats.natural20s}</div>
                </div>
              )}
              {stats.natural1s > 0 && (
                <div className="p-3 bg-red-50 rounded-lg">
                  <div className="text-xs text-gray-600">Natural 1s</div>
                  <div className="text-2xl font-bold text-red-600">{stats.natural1s}</div>
                </div>
              )}
            </div>
          </div>
      ...
      <div className="max-w-4xl mx-auto mt-16 space-y-8">
        ...
        <section className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-6 lg:p-8 border border-gray-100">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Online Dice Roller for Tabletop Games</h2>
        ...
        <section className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-6 lg:p-8 border border-gray-100">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-2">🎲 D&D 5e</h3>
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-2">⚔️ Pathfinder</h3>
              <p className="text-gray-700 text-sm">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-2">🎯 Board Games</h3>
              <p className="text-gray-700 text-sm">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-2">📊 Statistics & Analysis</h3>
              <p className="text-gray-700 text-sm">
        ...
        <section className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-6 lg:p-8 border border-gray-100">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-semibold text-gray-900 mb-1">Multiple Dice Types</h3>
                <p className="text-gray-700 text-sm">
            ...
            <div className="flex items-start gap-3">
              <span className="text-2xl">➕</span>
              <div>
                <h3 className="font-semibold text-gray-900 mb-1">Bonuses & Modifiers</h3>
                <p className="text-gray-700 text-sm">
            ...
            <div className="flex items-start gap-3">
              <span className="text-2xl">🪙</span>
              <div>
                <h3 className="font-semibold text-gray-900 mb-1">Coin Flip</h3>
                <p className="text-gray-700 text-sm">
        ...
        <section className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-6 lg:p-8 border border-gray-100">
          ...
          <div className="space-y-6">
            <div>
              <h3 className="font-semibold text-gray-900 mb-2">How random are the dice rolls?</h3>
              <p className="text-gray-700 text-sm">
            ...
            <div>
              <h3 className="font-semibold text-gray-900 mb-2">Can I roll multiple dice at once?</h3>
              <p className="text-gray-700 text-sm">
            ...
            <div>
              <h3 className="font-semibold text-gray-900 mb-2">What dice types are supported?</h3>
              <p className="text-gray-700 text-sm">
            ...
            <div>
              <h3 className="font-semibold text-gray-900 mb-2">How do bonuses work?</h3>
              <p className="text-gray-700 text-sm">
